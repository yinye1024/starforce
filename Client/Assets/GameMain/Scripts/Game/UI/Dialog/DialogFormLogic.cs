...
{
    public class DialogFormLogic : UGuiFormLogic
    {
        [SerializeField]
        ...
        private void RefreshConfirmText(string confirmText)
        {
            ...
            {
                confirmText = LocalizationMgr.Instance.GetString("Dialog.ConfirmButton");
            }
        ...
        private void RefreshCancelText(string cancelText)
        {
            ...
            {
                cancelText = LocalizationMgr.Instance.GetString("Dialog.CancelButton");
            }
        ...
        private void RefreshOtherText(string otherText)
        {
            ...
            {
                otherText = LocalizationMgr.Instance.GetString("Dialog.OtherButton");
            }
